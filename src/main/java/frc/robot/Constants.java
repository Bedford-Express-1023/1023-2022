...
public class Constants {
    ...
    public static final double SWERVE_SPEED_MULTIPLIER = .55; //use to limit speed
    public static final double MAX_VELOCITY_METERS_PER_SECOND = 4; //Literally a measure of how fast the swerves could possibly go
